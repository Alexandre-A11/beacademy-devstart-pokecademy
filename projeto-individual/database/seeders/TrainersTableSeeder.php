...
class TrainersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        [
            ...
            'image' => Storage::disk('s3')->putFile('trainers', new File('storage/app/public/avatars/1.png')),
        ...
        [
            ...
            'image' => Storage::disk('s3')->putFile('trainers', new File('storage/app/public/avatars/2.jpg')),
            'password' => bcrypt('12345678'),
            'isAdmin' => 0,
        ],
        [
            ...
            'image' => Storage::disk('s3')->putFile('trainers', new File('storage/app/public/avatars/3.jpg')),
            'password' => bcrypt('12345678'),
            'isAdmin' => 0,
        ],
        [
            ...
            'image' => Storage::disk('s3')->putFile('trainers', new File('storage/app/public/avatars/4.png')),
            'password' => bcrypt('12345678'),
            'isAdmin' => 0,
        ],
        [
            ...
            'image' => Storage::disk('s3')->putFile('trainers', new File('storage/app/public/avatars/5.png')),
            'password' => bcrypt('12345678'),
            'isAdmin' => 0,
        ],
        [
            ...
            'image' => Storage::disk('s3')->putFile('trainers', new File('storage/app/public/avatars/6.jpg')),
            'password' => bcrypt('12345678'),
            'isAdmin' => 0,
        ],
        ['name' => 'Mike Doe',
            ...
            'image' => Storage::disk('s3')->putFile('trainers', new File('storage/app/public/avatars/7.jpg')),
            'password' => bcrypt('12345678'),
            'isAdmin' => 0,
        ],
    ]);
