<div class="flex flex-col sm:justify-center items-center py-6 sm:pt-0 bg-primary">
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-secondary shadow-md overflow-hidden sm:rounded-lg">
        ...
        <form method="POST" action="{{ route('pokemon.rename', $pokemon->id) }}" enctype="multipart/form-data">
            @method("PUT")
            @csrf
            ...
            <div>
                ...
                <x-input id="name" class="block mt-1 w-full bg-blue-300 focus:border-primary focus:ring focus:ring-primary" type="text" name="name" :value="$pokemon->name" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <div class="flex flex-wrap mt-1">
                    ...
                    <div class="flex items-center mr-4">
                        ...
                        </div> <label for="insect" class="ml-2 text-sm font-medium text-white">Inseto</label>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-4 flex text-center">
                ...
                <div class="mr-4">
                    ...
                    <x-input id="attack" class="block mt-1 w-full bg-blue-300 focus:border-primary focus:ring focus:ring-primary" type="text" name="attack" :value="$pokemon->attack" required />
                </div>

                <!-- Pokemon Power -->
                <div class="mr-4">
                    <x-label for="power" class="text-white" :value="__('Poder')" />
                    <x-input id="power" class="block mt-1 w-full bg-blue-300 focus:border-primary focus:ring focus:ring-primary" type="number" name="power" :value="$pokemon->power" required />
                </div>
            </div>
            ...
            <div class="mt-4 flex text-center">
                ...
                <div class="mr-4">
                    ...
                    <x-input id="defense" min="0" class="block mt-1 w-full bg-blue-300 focus:border-primary focus:ring focus:ring-primary" type="number" name="defense" :value="$pokemon->defense" />
                </div>

                <!-- Pokemon Healthy -->
                <div class="mr-4">
                    <x-label for="healthy" class="text-white" :value="__('Vida')" />
                    <x-input id="healthy" min="1" class="block mt-1 w-full bg-blue-300 focus:border-primary focus:ring focus:ring-primary" type="number" name="healthy" :value="$pokemon->healthy" />
                </div>

                <!-- Pokedex -->
                <div class="mr-4">
                    <x-label for="pokedex" class="text-white" :value="__('Pokedex')" />
                    <x-input id="pokedex" min="1" class="block mt-1 w-full bg-blue-300 focus:border-primary focus:ring focus:ring-primary" type="number" name="pokedex" :value="$pokemon->pokedex_id" />
                </div>
            </div>
            ...
            <div class="mt-4 text-center flex justify-center">
                ...
                <div class="mr-4">
                    <x-label for="weakness_type" class="text-white">Fraco Contra:</x-label>
                    <select id="weakness_type" name="weakness_type" :value="$pokemon->weakness_type" class="block mt-1 w-full rounded-md shadow-sm bg-blue-300 focus:border-primary focus:ring focus:ring-primary">
                ...
                <div class="mr-4">
                    ...
                    <x-input id="weakness" min="1" max="5" class="block mt-1 w-full bg-blue-300 focus:border-primary focus:ring focus:ring-primary" type="number" name="weakness" :value="$pokemon->weakness" required />
                </div>
            </div>
            ...
            <div class="mt-4 grid justify-items-center">
                ...
                <x-input id="stars" min="1" max="5" class="block mt-1 w-1/2" type="range" name="stars" :value="$pokemon->stars" oninput="this.nextElementSibling.value = this.value" /><output class="text-white font-bold">{{ $pokemon->stars }}</output>
            </div>

            <!-- Image -->
            <div class="mt-4 text-center">
                <x-label for="image" class="text-white" :value="__('Imagem')" />
                <x-input id="image" class="block mt-1 w-full bg-blue-300 focus:border-primary focus:outline-none focus:ring focus:ring-primary" type="file" name="image" :value="$pokemon->image" />
            </div>
